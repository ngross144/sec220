...
insert into products (id, product, cost, manufacturer) VALUES (7, 'stuff', 2, 'people');
insert into products (id, product, cost, manufacturer) VALUES (8, 'things', 2, 'people');
insert into products (id, product, cost, manufacturer) VALUES (9, 'objects', 2, 'people');
insert into products (id, product, cost, manufacturer) VALUES (10, 'junk', 2, 'people');
...
delete from products where id in (8, 9, 10);
